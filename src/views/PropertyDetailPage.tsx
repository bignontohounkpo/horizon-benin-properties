          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl shadow-card p-6">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full mt-4 bg-transparent border-2 border-success text-success font-semibold py-3 rounded-full hover:bg-success/5 transition-colors"
              >
