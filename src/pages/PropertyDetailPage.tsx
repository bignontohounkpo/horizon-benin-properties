          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl shadow-card p-6">
              ...
              <a
                ...
                className="w-full mt-3 bg-transparent border-2 border-success text-success font-bold py-3 rounded-full flex items-center justify-center gap-3 hover:bg-success/5 transition-colors"
              >
